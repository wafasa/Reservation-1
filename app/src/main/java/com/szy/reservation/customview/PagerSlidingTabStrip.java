...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = 0xFF4081DA;
	private int underlineColor = 0xFF4081DA;
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawRect(lineLeft, height - indicatorHeight, lineRight, height-6, rectPaint);
