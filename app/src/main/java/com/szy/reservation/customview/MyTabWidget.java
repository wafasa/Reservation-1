...
import com.szy.reservation.exception.CustomException;
import com.szy.reservation.utils.LogUtils;
...
public class MyTabWidget extends LinearLayout {
	...
	private int[] mDrawableIds = new int[] { R.drawable.bg_home,
			R.drawable.bg_statistics, R.drawable.bg_user_center};
	...
	private void init(final Context context) {
		...
		for (int i = 0; i < size; i++) {
			...
			if (i == 0) {
				...
				itemName.setTextColor(Color.rgb(64, 129, 218));
	...
	public void setTabsDisplay(Context context, int index) {
		...
		for (int i = 0; i < size; i++) {
			...
			if ((Integer) (checkedTextView.getTag()) == index) {
				...
				checkedTextView.setTextColor(Color.rgb(64, 129, 218));
